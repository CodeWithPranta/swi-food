<div>
    <a href="" class="focus:ring-0">
    @if ($cartCount > 0)
        <sup class="ml-1 text-sm bg-red-500 text-white rounded-full">{{ $cartCount }}</sup>
    @endif
    <svg fill="none" class="w-5 h-5 cursor-pointer text-white mt-1.5 mr-2 md:mt-0" stroke="currentColor" stroke-width="1.5"
