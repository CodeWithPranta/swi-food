<div>
    ...
    @if ($cartCount > 0)
        <sup class="px-2 pt-0.5 md:pt-0 text-sm md:text-md bg-red-500 text-white font-semibold rounded-full">{{ $cartCount }}</sup>
    @endif
    <svg class="w-5 h-5 md:w-6 md:h-6 cursor-pointer text-gray-950 mt-1.5 mr-2 md:mt-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
