                ...
                <ul
                    ...
                    @if (Route::has('login'))
                        <x-dropdown>
                            ...
                            @else
                                <x-dropdown-link href="{{ route('login') }}">{{ __('Customer Login') }}</x-dropdown-link>
                                <x-dropdown-link href="{{ route('register') }}">{{ __('Registration') }}</x-dropdown-link>
                                <x-dropdown-link
                                    href="{{ route('filament.vendor.auth.login') }}">{{ __('Homestaurant Login') }}</x-dropdown-link>
                            @endauth
                        </x-dropdown>
                    @endif
                </ul>
